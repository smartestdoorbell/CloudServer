let express,Expo;_d95‍.w("express",[["default",["express"],function(v){express=v}]]);_d95‍.w("expo-server-sdk",[["default",["Expo"],function(v){Expo=v}]]);
  ...
  (async () => {
    ...
    for (let chunk of chunks) {
      try {
        ...
        _d95‍.g.console.log(receipts);
      } catch (error) {
        _d95‍.g.console.error(error);
      }
    }
  })();
};
