let express,Expo;_d03‍.w("express",[["default",["express"],function(v){express=v}]]);_d03‍.w("expo-server-sdk",[["default",["Expo"],function(v){Expo=v}]]);

const { User, Ring, db } = require("./database/db");
const downloadImage = require("/database/snapshotToDropbox");
const Fs = require("fs");
  ...
  (async () => {
    ...
    for (let chunk of chunks) {
      try {
        ...
        _d03‍.g.console.log(receipts);
      } catch (error) {
        _d03‍.g.console.error(error);
      }
    }
  })();
};
...
app.post("/message", async (req, res) => {
  ...
  const DropURL = await grabSnapShoturl(url, timeStampFromCam);
